...
def get_model_settings(env: Mapping[str, str] | None = None, env_file: Path | str | None = None) -> ModelSettings:
    ...
    fallback_backup_image = ImageGenerationSettings(
        ...
        base_url=_read(source, "FALLBACK_IMAGE_GENERATION_BACKUP_BASE_URL", "https://yunwu.ai/v1"),
        endpoint_path=_read(source, "FALLBACK_IMAGE_GENERATION_BACKUP_ENDPOINT_PATH", "/images/generations"),
        model=_read(source, "FALLBACK_IMAGE_GENERATION_BACKUP_MODEL", "gpt-image-2-all"),
    ...
    fallback_image = ImageGenerationSettings(
        ...
        base_url=_read(source, "FALLBACK_IMAGE_GENERATION_BASE_URL", _read(source, "LEGACY_IMAGE_GENERATION_BASE_URL", "https://api-xai.ainaibahub.com/v1")),
